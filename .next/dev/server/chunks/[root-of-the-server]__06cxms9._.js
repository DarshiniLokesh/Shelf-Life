...
async function POST(req) {
    try {
        ...
        if (existingUser) {
            ...
            if (!token) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    status: 200
                } // Return 200 but indicating we need the token
                );
            }
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.create({
            data: {
                name,
                token: generatedPin
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06cxms9._.js.map